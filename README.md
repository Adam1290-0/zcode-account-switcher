...
|---|---|---|---|
| **v1.0.2（最新）** | **3.10.1 / 3.10.2 / 3.11.2** | ✅ 当前维护版本 | **修复切换不完整**：套餐/额度状态（config builtin token、providerFamily、套餐缓存）随账号一并切换；推广链接带邀请后缀 |
...
- 🆙 验证适配 ZCode 3.10.2 / 3.11.2（主进程/渲染层/全部文本锚点未变，隔离注入通过）
